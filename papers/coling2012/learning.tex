...
To estimate the probability of use R.\puse for new scenes we calculate the R.\puse of each training scene target $t$ in the corpus in the following way.
