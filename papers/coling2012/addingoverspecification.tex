...
that the original incremental algorithm allows.  But it has been argued~\cite{xxx} that 
a might higher degree of overspecification is usually found in corpora, and this 
is indeed what can be seen in the GRE3D7 corpus.  As we can see in Table~\ref{xxx}, 
