...
be described by the same description.  This classification is successively refined (while possible) till the target 
is the only element fitting the description of its class.  The existence of a RE for the target will 
...
In this article we continue this line of research.  The partition algorithms described in~\cite{arec2:2008:Areces,arec:usin11} require an 
