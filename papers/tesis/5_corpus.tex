...
%\hline
%Palabra                                             Probabilidad\\ \hline \hline
%\textbf{\texttt{Restaurante 0.95}}\\
%\textbf{\texttt{MedinaMayrit 0.738}}\\
%\textbf{\texttt{ProxA 0.63}}\\
%\textbf{\texttt{in 0.554}}\\
%\textbf{\texttt{CalleAtocha 0.507}}\\
%\textbf{\texttt{Church 0.261}}\\
%\textbf{\texttt{CalleDeLaCruz 0.169}}\\
%\textbf{\texttt{CalleDeCarretas 0.061}}\\
%\hline
%\end{tabular}
%\caption{Probabilidad de las palabras del dominio.}\label{prob-vocabulario-zoom}
%\end{center}
