...
Las situaciones de referencia en cuesti\'on hacen uso de mapas con dos grados de detalle (representados por los niveles de zoom de alto y bajo)\textcolor{blue}{cerca y lejos?}, se pidieron descripciones en singular y plural, tuvimos en cuenta un gran n\'umero de personas (unos 100 hablantes de cada idioma). Un fragmento de la interfaz experimento se muestra en la Fig.\ref{fig-interface}.

\textcolor{blue}{cambiar imagen}
...
\textcolor{blue}{Esta seccion se llamaba Subjects...}
