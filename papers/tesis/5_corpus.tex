...
En este cap\'itulo vimos como se recolect\'o el corpus Zoom, los materiales para la recolecci\'on estan en \ref{corpus-apendice}, la anotaci\'on del corpus, el an\'alisis y evaluaci\'on del mismo. 

Este corpus cuenta con ER generadas por humanos, podemos encontrar distintos tipos de ER como las nombradas en \ref{sec:seleccion}, tenemos varias ER por mapa con lo cual podremos luego calcular las probabilidades de uso de las palabras como se explic\'o en \ref{sec:learning} para ejecutar nuestro algoritmo explicado en \ref{sec:algoritmo}. Dadas las caracter\'isticas de los mapas usados para la recolecci\'on el corpus el corpus tiene ER relacionales, ER de plurales, y ER sobre-especificadas. 
