...
%Se indica la cantidad de veces que aparecieron en el corpus, 
...
Se ejecut\'o el algoritmo 1000 veces, con input el modelo mostrado en la Figura \ref{modelo-mapa-zoom} y las probabilidades dadas en la Tabla \ref{prob-vocabulario}, se muestran las 10 f\'ormulas m\'as frecuentes, y la frecuencia dada por el algoritmo en la Tabla \ref{freq-mapa-algoritmo}
...
Otra subf\'ormula rara que vemos es $\exists \nFront .(\exists \nFront .(\exists \nChurch))$, que por ser un algoritmo l\'ogico tambi\'en podr\'iamos eliminarlos, teniendo en cuenta que $\exists \nFront .(\exists \nFront .(\exists \nChurch))$ es igual a decir $\exists \nChurch$.
...
\hline
 &Posible realizaci\'on de la ER dada en misma posici\'on de la Tabla \protect\ref{formulas-mapa-zoom}&  \# & \% \\ \hline
1-5&Iglesia en la calle de Santo Tom\'as   & & \\ \hline
2&La que est\'a frente al Ministerio de Asuntos Exteriores & & \\ \line
3&Iglesia en la calle de Atocha & & \\ \hline
4&La que est\'a cerca al Ministerio de Asuntos Exteriores & & \\ \line
5&Iglesia frente al Ministerio de Asuntos Exteriores                                   & & \\ \hline                                        
6&Iglesia frente al Ministerio de Asuntos Exteriores y que est\'a en una calle        & &2.5\%  \\ \hline
%&Asuntos Exteriores& & & & \\ \hline
7&Iglesia que est\'a en una calle y que tiene al frete algo que esta en la Calle de Santo Tom\'as & & \\ \hline                                
6&En calle de Santo Tom\'as                                                                        & & \\ \hline                                
7&Iglesia que est\'a en la Calle de Santo Tom\'as y Atocha,                                       & &\% \\ 
8&Al frente al Ministerio de Asuntos Exteriores que est\'a en una calle                          && \\ \hline                               
9&Cerca del Ministerio de Asuntos Exteriores que est\'a en una calle                            & & \\ \hline
%10&                                 & & \\ \hline                                              
\end{tabular}
...
%Ex-frente.(Ex-frente.(Ex-iglesia.(T))) & Ex-in.(Ex-CalleDeSantoTomas.(T)): church1->74 va a 1
%Ex-cerca.(Ex-MinisterioAsuntosExteriores.(T) & Ex-in.(T)): church1->15


%La f\'ormula (1) ``Ex-iglesia.(T) \& Ex-in.(Ex-CalleDeSantoTomas.(T))'' se podr\'ia realizar como ``La iglesia que est\'a en la Calle 
%De Santo Tom\'as''. La f\'ormula (2) se podr\'ia realizar como ``La que est\'a al frente del Ministerio de Asuntos Exteriores''. 
%La f\'ormula (3) como ``La iglesia de la Calle De Atocha''. La f\'ormula (4) con ``Una que esta cerca del Ministerio de Asuntos Exteriores''
% y la (5) ``La que esta en Calle de Santo Tomas al frente de algo que tiene al frente una iglesia''. 
%Este \'ultimo tipo de f\'ormulas son las menos deseadas y las menos naturales, podemos ver que en este caso la di\'o el 7\% de las veces, 
%lo cual no es muy alto. Todas las f\'ormulas que di\'o el algoritmo en 1000 ejecusiones con sus respectivas frecuencias se muestran 
%en el Ap\'endice en Secci\'on \ref{er-mapa-zoom}.
