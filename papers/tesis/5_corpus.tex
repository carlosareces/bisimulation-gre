...
En esta secci\'on presentamos el estudio de dos casos particulares, los cuales son mucho m\'as naturales que los que hab\'iamos visto hasta el momento: la generaci\'on autom\'atica de ER para dos mapas del ZOOM corpus uno con zoom x y otro con zoom 2X del mismo target. El mapa singular usado se muestra en la Figura \ref{mapa-zoom} y el mapa con zoom 2X, se muestra en Figura \ref{mapa-zoom2x}. Veremos las diferencias entre ambos mapas a nivel de informaci\'on disponible, obtendremos a partir de la imagen el modelo y a partir de las ER's del corpus las probabilidades de uso para luego ejecutar el algoritmo.

\begin{figure}
\centering
\includegraphics[width=\textwidth]{images/corpus/mapa6.png}\\[0pt]
\caption{Imagen del ZOOM corpus}
\label{mapa-zoom}
\end{figure}

Podemos notar que en la imagen con zoom se puede ver el target, el cual est\'a se\~nalado por una flecha roja, seg\'un la leyenda que se ubica a la derecha, podemos decir que se trata de una iglesia, en la imagen se ve el nombre de la iglesia, ``Parroquia de Santa Cruz'', otra cosa que se puede ver en el mapa con zoom es el nombre de la calle que esta abajo ``Calle de la Concepci\'on Jeronima'', en este mapa no se puede ver el nombre del Ministerio de Asuntos Exteriores, por lo tanto lo \'unico que se ve en la Calle de Santo Tom\'as es la iglesia target.

En la Tabla \ref{freq-mapa} y \ref{freq-mapa-zoom} se muestran las ER dadas por las personas, y la frecuencia que cada una representa en el corpus, para ambos mapas respectivamente

\begin{figure}
\centering
\includegraphics[width=\textwidth]{images/corpus/mapa16.png}\\[0pt]
\caption{Imagen con zoom 2X}
\label{mapa-zoom2x}
\end{figure}
...
\begin{tabular}{|l|c|c|c|}
\hline
ER 					      & Cantidad &  Frecuencia & Minimal-Sobreespecificada\\ \hline \hline
Iglesia en calle Santo Tomas frente al Ministerio de Asuntos Exteriores        &	11	&	0.1358\% & \\ \hline
Iglesia en calle Santo Tomas cerca del Ministerio de Asuntos Exteriores        &	2   &	0.0246\% &	\\ \hline
Iglesia  frente al Ministerio de Asuntos Exteriores &11&0.1358\% &\\ \hline
Iglesia cerca del Ministerio de Asuntos Exteriores&1&0.0123\% &\\ \hline
Iglesia en calle Santo Tomas&15&0.185\% &\\ \hline
La Iglesia en Calle de Atocha&2&0.0246\% &\\ \hline
La iglesia (sub tipo I)&16&0.197\% &\\ \hline
Calle de santo tomas  (es er)&2&0.0246\% &\\ \hline
La iglesia que est\'a en la Calle de Santo Tom\'as y Atocha, & & &\\ 
frente al Ministerio de Asuntos Exteriores&1&0.0123\% &\\ \hline
La iglesia que est\'a en la Calle de Santo Tom\'as y Atocha&2&0.0246\% &\\ \hline
NO-ERA-ER&18&0.222\% &\\ \hline \hline
Totales&81&100\% &\\

\hline
\end{tabular}
\caption{ER del corpus dadas por humanos para el mapa \ref{mapa-zoom}.}\label{freq-mapa}
\end{center}
\end{small}
\end{table}
...
\hline
\end{tabular}
\caption{ER del corpus dadas por humanos para el mapa \ref{mapa-zoom2x}.}\label{freq-mapa-zoom}
\end{center}
\end{small}
\end{table}

Necesitamos definir el vocabulario del modelo, es decir las palabras que vamos a usar al correr el algoritmo, la sem\'antica del mismo, lo cual no significa que usemos esas mismas palabras para la ER final, la misma palabra se podr\'ia realizar con diferentes expresiones. Por ejemplo la palabra ``in-front-of'' se podr\'ia realizar como ``frente a'', ``al frente de''. Estas palabras fueron sacadas de la anotaci\'on del corpus, el cual est\'a anotado en ingl\'es. Algunas personas dijeron ``en la esquina de...'', eso fue anotado como ``between'' y luego 2 calles, esta palabra no fue usada porque tiene 2 par\'ametros, en cambio usamos ``en'' para ambas calles, con esa modificaci\'on, no estamos perdiendo informaci\'on ya que si el algoritmo da ambas calles, lo podr\'iamos realizar como ``esquina''. El siguiente es el vocabulario final.
...
y construir el modelo, el cual luego se muestra en formato XML:
...
%
%<?xml version="1.0"?>
%<problem refer-to="church1">
  %<individual id="church1">
    %<related rel="in" to="str9" />
    %<related rel="in" to="str10" />
    %<related rel="frente" to="min1" />
    %<related rel="cerca" to="min1" />
    %<related rel="iglesia" to="c" />
  %</individual>
  %<individual id="church2">
    %<related rel="in" to="str16" />
    %<related rel="cerca" to="rest4" />
    %<related rel="frente" to="d" />
%<related rel="cerca" to="d" />
    %<related rel="iglesia" to="c" />
  %</individual>
  %<individual id="str10">
    %<related rel="street" to="c" />
    %<related rel="CalleDeSantoTomas" to="c" />
  %</individual>
  %<individual id="str15">
    %<related rel="street" to="c" />
  %</individual>
  ...
  %<individual id="str9">
    %<related rel="street" to="c"/>
    %<related rel="CalleDeAtocha" to="c" />
  %</individual>
  %<individual id="str12">
    %<related rel="street" to="c"/>
    %<related rel="CalleDeElSalvador" to="c" />
  %</individual>
  %<individual id="rest3">
    %<related rel="in" to="str9" />
    %<related rel="in" to="str15" />
%<related rel="MedinaMayrit" to="c" />
    %<related rel="restaurante" to="c" />
  %</individual>
  %<individual id="rest4">
    %<related rel="in" to="str16" />
    %<related rel="frente" to="d" />
    %<related rel="restaurante" to="c" />
    %<related rel="cerca" to="church2" />
  %</individual>
  %<individual id="min1">
    %<related rel="in" to="str10"/>
    %<related rel="in" to="str12"/>
    %<related rel="in" to="str9"/>
    %<related rel="in" to="str17"/>
    %<related rel="MinisterioAsuntosExteriores" to="c" />
    %<related rel="frente" to="church1" />
    %<related rel="cerca" to="church1" />
		%<related rel="building" to="c" />
   %</individual>
   %<individual id="c">
   ...
   %<individual id="d">
    %<related rel="in" to="str16"/>
    %<related rel="in" to="str9"/>
    %<related rel="frente" to="church2" />
    %<related rel="frente" to="rest4" />
    %<related rel="cerca" to="church2" />
    %<related rel="cerca" to="rest4" />
    %<related rel="terminal" to="d" />
   %</individual>
%</problem>
%\end{verbatim}
...
Ahora vamos a mostrar el modelo del mapa \ref{mapa-zoom2x}
...
\begin{tikzpicture}
  [
	...
	%\node[n,label=above:$str12\nStreet$,label=below:{
    %\relsize{-2}$\begin{array}{c}
      %\nCalle\\[-3pt] 
      %\nDe \\[-3pt] 
			%\nEl \\[-3pt] 
      %\nSalvador\end{array}$}, right of=a] (b) {};
   %\node[n,label=below:$str20\nStreet$,label=above:{
    %\relsize{-2}$\begin{array}{c}
      %\nStreetConComa\\[-3pt] 
   		%\nConJer\end{array}$}, below of=c] (q) {};
 \node[n,label=below:$str20$,label=right:{
    \relsize{-2}$\begin{array}{c}
      \nStreet\\[-3pt] 
      CalleConJer\end{array}$}, below of=a] (q) {};		

	\node[n,label=below:$str16$,label=above:{
    \relsize{-2}$\begin{array}{c}
      \nStreet\end{array}$}, right of=q] (m) {};		 

  \node[n,label=below:$str10\nStreet$,label=above:{
    \relsize{-2}$\begin{array}{c}
		  \nStreet\\[-3pt] 
      \nCalleSantoTomas\end{array}$}, above of=q] (c) {};	
				
 \node[n,label=left:$min1\nBuilding$,label=above:{
    \relsize{-2}}, above of=a] (f) {};	
					
  \node[n,label=left:$church1$,label=above:{
    \relsize{-2}$\begin{array}{c}
      \nChurch\\[-3pt] 
      ParSantaCruz\end{array}$}, above of=f] (g) {};
			
 \node[n,label=above:$church2$,label=below:{
    \relsize{-2}$\begin{array}{c}
      \nChurch\end{array}$}, right of=c] (d) {};
...
\node[n,label=below:$rest4$,label=above:{
    \relsize{-2}$\begin{array}{c}
      \nRestaurante\end{array}$}, right of=m] (k) {};

 \node[n,label=below:$rest6$,label=above:{
    \relsize{-2}$\begin{array}{c}
      \nRestaurante\\[-3pt] 
      LaTagliatella\end{array}$}, below of=k] (p) {};		
 ...
 \node[n,label=above:$str15$,label=below:{
    \relsize{-2}$\begin{array}{c}
      \nStreet\end{array}$}, above of=i] (j) {};	
\node[n,label=above:$str21$,label=below:{
    \relsize{-2}$\begin{array}{c}
      \nStreet\end{array}$}, above of=i] (r) {};	
...
%<problem refer-to="church1">
 %<individual id="church1">
    %<related rel="in" to="str9" />
    %<related rel="in" to="str10" />
    %<related rel="in" to="str20" />
    %<related rel="frente" to="min1" />
    %<related rel="cerca" to="min1" />
    %<related rel="ParroquiaDeSantaCruz" to="c" />
    %<related rel="iglesia" to="c" />
 %</individual>
 %<individual id="church2">
    %<related rel="in" to="str16" />
    %<related rel="cerca" to="rest6" />
    %<related rel="frente" to="thea0" />
    %<related rel="cerca" to="thea0" />
    %<related rel="iglesia" to="c" />
 %</individual>
 %<individual id="str10">
    %<related rel="street" to="c" />
 ...
 %<individual id="str20">
    %<related rel="street" to="c"/>
    %<related rel="CalleDeLaConcepcionJeronima" to="c" />
 %</individual>
 %<individual id="str21">
    %<related rel="street" to="c"/>
 %</individual>
 ...
 %<individual id="rest6">
    ...
    %<related rel="cerca" to="thea0" />
     %<related rel="cerca" to="rest4" />
    %<related rel="restaurante" to="c" />
    %<related rel="LaTagliatella" to="c" />
%<related rel="cerca" to="church2" />
 %</individual>
 %<individual id="thea0">
    %<related rel="in" to="str9" />
    %<related rel="in" to="str16" />
    %<related rel="frente" to="rest6" />
    %<related rel="frente" to="rest4" />
    %<related rel="frente" to="church2" />
    %<related rel="cerca" to="rest6" />
    %<related rel="cerca" to="rest4" />
    %<related rel="cerca" to="church2" />
    %<related rel="theater" to="c" />
    %<related rel="TeatroCalderon" to="c" />
 %</individual>
 %<individual id="min1">
    %<related rel="in" to="str20"/>
    %<related rel="in" to="str10"/>
    %<related rel="in" to="str21"/>
    %<related rel="frente" to="church1" />
    %<related rel="cerca" to="church1" />
    %<related rel="building" to="c" />
  %</individual>
...
Tambi\'en estudiamos para ``casi'' el mismo modelo que de la Figura \ref{mapa-zoom}, pero para uno con plural el mapa se muestra en la Figura \ref{mapa-zoom-plural}

El modelo tiene las siguientes modificaciones, las cuales fueron necesarias para poder cubrir las ER dadas por las personas.  
...
Las probabilidades y el vocabulario se muestran a continuaci\'on:
