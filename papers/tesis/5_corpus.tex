...
En cada uno de los mapas, el o los targets est\'an se\~nalados por flechas rojas, seg\'un la leyenda que se ubica a la derecha, podemos decir que si se trata de una iglesia, o restaurantes, etc. En la Figura \ref{mapa-zoom2x} se ve el nombre de la iglesia, ``Parroquia de Santa Cruz'', lo cual no se ve en la Figura \ref{mapa-zoom}, otra cosa que se puede ver en el mapa con zoom es el nombre de la calle que esta abajo ``Calle de la Concepci\'on Jeronima'', en este mapa no se puede ver el nombre del Ministerio de Asuntos Exteriores, por lo tanto lo \'unico que se ve en la Calle de Santo Tom\'as es la iglesia target. El mapa de la Figura \ref{mapa-zoom-plural} coincide con el mapa de la Figura \ref{mapa-zoom} pero los targets son en ese caso 2 restaurantes.

En las Tablas \ref{freq-mapa}, \ref{freq-mapa-zoom} y \ref{freq-mapa-zoom-plural} se muestran las ER dadas por las personas, y la frecuencia que cada una representa en el corpus, para los 3 mapas respectivamente.
...
Parroquia de Santa Cruz        												 &		44&	\%  & SI  \\
Parroquia de Santa Cruz en Calle De Santo Tomas        &	 9  &	\%	& NO\\
Parroquia de Santa Cruz en Calle De Santo Tomas        &	 3  &	\%	& NO\\
entre Calle De Atocha y De La Concepci\'on Jer\'onima  &	    &			&  \\
Calle De Santo Tomas	        												 &		1 &	\%	&SI\\
Iglesia de la Parroquia de Santa Cruz	      					 &		2 &	\%	&NO\\
Parroquia de Santa Cruz en Calle De Santo Tomas  			 &	  3 &	\%	&NO\\
cerca de Ministerio de Asuntos Exteriores							 &	  &		&\\
Parroquia de Santa Cruz en Calle De Santo Tomas y      &	 4 &	\%	& NO\\
De La Concepci\'on Jer\'onima  &	  &					&\\
Iglesia de la Parroquia de Santa Cruz	en Calle De Santo Tomas      &		2&	\%	&NO\\
Iglesia cerca deL Ministerio de Asuntos Exteriores				&	 1 &		&SI\\
Parroquia de Santa Cruz  &	  1&	\%	&NO\\
cerca de Ministerio de Asuntos Exteriores				&	  &		&\\
Parroquia de Santa Cruz en Calle De Atocha  &	  1&	\%	&NO\\
cerca de Ministerio de Asuntos Exteriores				&	  &		&\\
Iglesia				&  1 &	\%	&\\
NO ERA ER				&	8  &	\%	&\\
...
\hline
\end{tabular}
\caption{ER del corpus dadas por humanos para el mapa \ref{mapa-zoom-plural}.}\label{freq-mapa-zoom-plural}
\end{center}
\end{small}
\end{table}
