...
tambi\'en fue la m\'as frecuente dada por el algoritmo como se muestra en la Tabla \ref{compara-corpus-alg} y con un porcentaje bastante parecido
...
En este mapa no se puede ver el nombre del Ministerio de Asuntos Exteriores porque este queda cortado en la imagen, el mismo si se ve\'ia en el mapa de la secci\'on anterior (Figura \ref{mapa-zoom1}), por lo tanto lo \'unico que se v\'e en la Calle de Santo Tom\'as es la iglesia target. 

En la Tabla \ref{freq-mapa-zoom2x} se muestran las 12 ERs distintas dadas por los participantes que completaron el experimento en la recolecci\'on del corpus, y la cantidad de ocurrencias en el corpus. Hacen un total de 72 ERs, el corpus contaba con 80 ERs para esa imagen, pero 8 fueron descartadas por no ser ERs.

\begin{figure}
\centering
\includegraphics[width=150mm]{images/corpus/mapa16.png}\\[0pt]
...
9&Calle De Santo Tom\'as                                   &    1 &     1.39\%      &X&\\  \hline
