...
Los 26 o 52 atributos nombrados anteriormente est\'an formados por:
...
\begin{itemize}
  ...
  \item cerca como por ejemplo pub1 est\'a cerca de fast5\\[-2.2em]
...
\noindent
Los restantes 16 atributos denotan propiedades de los objetos adicionales (landmarks) que se mencionaron en la descripci\'on, a los cuales llamamos d1.. d4. Por ejemplo, en {\it El pub que est\'a al lado de Pans \& Company, en la calle de las Postas}) tenemos: target = pub, d1 = fast-food (Pans \& Company).% y d2 = Street (calle de las Postas).
...
\end{verbatim}
%}
\caption{Fragmento de XML de la ER ``El pub que est\'a al lado de Pans \& Company, en la calle de las Postas''.}\label{xml}
\end{figure}
%\normalsize
...
1&Medina Mayrit y el que est\'a cerca        &	11	&	18.3\% &  &  &\\ \hline
...
15&El que est\'a en calle de Atocha y Carretas, 	      &	1	&	1.6\%	&&&\\
...
1&Medina Mayrit y el que est\'a cerca        					  &	18.3\%  &   30.3\%  &18.3\% \\ \hline
