...
%\renewcommand{\refname}{Bibliogra}
...
\newcommand{\CL}{\ensuremath{\mathcal{C}}\xspace}
\newcommand{\PL}{\ensuremath{\mathcal{P}}\xspace}
...
\hyphenation{e-va-lua-cio-nes}
\hyphenation{e-va-lua-mos}
\hyphenation{exac-ti-tud}
\hyphenation{exis-ten-te}
\hyphenation{exis-ten-tes}
...
\hyphenation{psi-co-lin-g\"u\'is-ti-co}
...
\newcommand{\nCalleConJer}{calleDeLaConJer}\xspace
...
%\usepackage{babelbib}
\renewcommand{\bibname}{Bibligraf\'ia}
\renewcommand{\algorithmname}{Algoritmoooo}
%}
%\begin{frame}
...
\include{2_expresiones_referenciales}% definiciones ER y corpus existentes
\include{3_intro_logica}
%
\include{4_algoritmo}
%
...
%\usepackage{babelbib}
%  \renewcommand{\bibname}{bibliooooo}
%}
%\begin{frame}
%  \frametitle{Bibliograf\'ia}
%\printbibliography[title = {Bibliograf\'ia}]
