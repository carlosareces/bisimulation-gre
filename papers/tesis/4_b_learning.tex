...
\newsavebox{\mybox} 
\savebox{\mybox}{\includegraphics[scale=0.40]{images/rojo-amarillo.png}} 
 \begin{figure}
   \begin{picture}(8,6)
...
\newsavebox{\mybox} 
\savebox{\mybox}{\includegraphics[scale=0.40]{images/imagenesML.png}} 
 \begin{figure}
   \begin{picture}(8,6)
  \put(0,0){\usebox{\mybox}} 
  %\put(2,2.5){\oval(6,5)}
...
\newsavebox{\mybox} 
\savebox{\mybox}{\includegraphics[scale=0.40]{images/3.jpg}} 
 \begin{figure}
   \begin{picture}(8,6)
  \put(0,0){\usebox{\mybox}} 
  %\put(2,2.5){\oval(6,5)}
...
\newsavebox{\mybox} 
\savebox{\mybox}{\includegraphics[scale=0.40]{images/13.jpg}} 
 \begin{figure}
   \begin{picture}(8,6)
  \put(0,0){\usebox{\mybox}} 
  %\put(2,2.5){\oval(6,5)}
