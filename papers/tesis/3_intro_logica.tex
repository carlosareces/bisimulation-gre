...
La Figura \ref{22_para_relacional} no pertenece al corpus GRE3D7, fue intencionalmente modificada para mostrar un caso en el que las propiedades proposicionales no alcanzan para dar una ER del objeto se\~nalado por la flecha. Para esa figura el algoritmo podr\'ia empezar con $S(v)$ = large, red, ball y luego el \'unico sucesor ser\'ia el cubo, rojo con la relaci\'on right-of, lo cual borra los desm\'as distractores.


\begin{figure}[!ht]
\centering
\includegraphics[width=\textwidth]{images/22paraRelacional.jpg}
