...
Por lo tanto, en modelos finitos, las simulaciones capturan exactamente el concepto de similaridad.
...
\emph{subsumida} si existe tal descomposici\'on.
...
En~\cite{graph} introducen un algoritmo para computar la determinaci\'on de
...
(i)&(ii)&(iii)
\end{tabular}
 \caption{Algunos subgrafos conectados $(v,H)$ de la escena $\+S$ de la Figura~\ref{fig:dale-haddock}.\label{fig:subgraphs}}
 \end{figure}
