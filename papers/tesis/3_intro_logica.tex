...
El cap\'itulo esta dividido en 4 secciones, las cuales son: Secci\'on\ref{sec:seleccionandoLenguaje}, en la cual daremos ejemplos 
...
explicaremos el algoritmo base de nuestra propuesta, y para finalizar en la Secci\'on \ref{sec:notasFinales} daremos un resumen de lo expuesto en este cap\'itulo y contaremos como se linkea esta parte de la tesis con los dem\'as cap\'itulos.
...
Considere la Figura \ref{target_mapa_3ball}, y sea $\+L$ tal que s\'olo se puede tener conjunciones de propiedades proposicionales, 
