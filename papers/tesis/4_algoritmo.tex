...
es decir ya tenemos informaci\'on m\'as precisa de los objetos que $\top$. Mir\'andolo como conjuntos $\interp{\top}$ = \{$e_1$,$e_2$,$e_3$,$e_4$,$e_5$,$e_6$, $e_7$\}, y los conjuntos \interp{\texttt{ball}}=\{$e_1$,$e_3$,$e_5$\} y la \interp{\texttt{cube}}=\{$e_2$,$e_4$,$e_6$,$e_7$\}. La union de los conjuntos $\interp{\texttt{ball}}$ y $\interp{\texttt{cube}}$ dan exactamente $\interp{\top}$.
...
\begin{figure}[ht]
\begin{center}
\frame{\includegraphics[width=8cm]{ejecucion/1-ball.jpg}}\\[0pt]
...
\begin{figure}[ht]
\begin{center}
\frame{\includegraphics[width=8cm]{ejecucion/2.jpg}}\\[0pt]
...
\begin{figure}[ht]
\begin{center}
\frame{\includegraphics[width=8cm]{ejecucion/3.jpg}}\\[0pt]
...
\begin{figure}[ht]
\begin{center}
\frame{\includegraphics[width=8cm]{ejecucion/4.jpg}}\\[0pt]
