...
Una f\'ormula es {\it Informativa} cuando tiene m\'as informaci\'on que las f\'ormulas que hay hasta el momento, es decir, la clase de la f\'ormula esta inclu\'ida en alguna otra f\'ormula y no es igual. Por ejemplo si tenemos las f\'ormulas ``pelota'' y ``cubo'' y queremos saber si ``pelota roja'' es informativa, si lo es ya que $e_5$ es una ``pelota roja'' y existen otras que no son rojas, es decir divide el conjunto de pelotas, por lo tanto si lo es. \\
...
verde pelota & 91 & 65.00\% \\
peque\~no verde pelota & 23 & 16.43\% \\
peque\~no verde pelota arriba de grande azul cubo & 8 & 5.71\% \\
verde pelota arriba de azul cubo & 5 & 3.57\% \\
verde pelota arriba de grande azul cubo & 5 & 3.57\% \\
peque\~no verde pelota arriba de azul cubo & 2 & 1.43\% \\
pelota arriba de cubo & 1 & 0.71\% \\
peque\~no verde pelota arriba de grande azul cubo a la izquierda & 1 & 0.71\% \\
peque\~no pelota arriba de grande cubo & 1 & 0.71\% \\
verde pelota arriba & 1 & 0.71\% \\
peque\~no pelota arriba de peque\~no cubo & 1 & 0.71\% \\
verde pelota arriba de cubo & 1 & 0.71\% \\
...
el target es descripto 16,43 \% de las veces como ``peque\~na pelota verde'' cuando ``pelota verde'' ya es una ER. Con el uso de los valores de \puse\ aprendidos con el c\'alculo explicado en la secci\'on anterior, el algoritmo~\ref{algo:bisim-l} no pueden simular este comportamiento.
