...
Ninguna pasa la probabilidad random R.\randuse del algoritmo, asi que continuamos incrementando las probabilidades, quedando como se muestran en la Tabla \ref{prob-inc2}. 
