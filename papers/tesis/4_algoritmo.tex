...
CALCULANDO P\_USE PARA TODO EL CORPUS VERDE-AZUL GRE3D7				
...
\hline
Palabra &average	error-LR	& error-PM	& f\'ormula de LR\\
\hline
ball		 &0.0465   &0.0609	  & 0.2894 * disc-gatt +0.7883\\
blue		 &0.0353	 &0.0454	  &0.848  * target-tiene +0.1073\\
center	 &0.0023	 &0.0037	  &0.0047 * target-tiene + \\
				 &				 &					&0.0047 * adj-target-tiene +0.0029 * vecino-tiene -0.009\\
...
small		 &0.1499	 &0.1755	  &0.3918 * target-tiene + \\
				 &				 &					&0.2478 * vecino-tiene -0.0913\\
front    & 				 & 					& \\
\hline
