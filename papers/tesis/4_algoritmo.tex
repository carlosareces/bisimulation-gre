...
CALCULANDO P_USE PARA TODO EL CORPUS VERDE-AZUL GRE3D7				
...
\hline
	...
	Palabra &average	error-LR	& error-PM	& formula de LR\\
	\hline

ball		&0.0465 &	0.0609	     & 0.2894 * disc-gatt +0.7883\\
blue		 &0.0353	 &0.0454	       &0.848  * target-tiene +0.1073\\
centre		 &0.0023	 &0.0037	       &0.0047 * target-tiene + 0.0047 * adj-target-tiene +0.0029 * vecino-tiene +-0.009\\
...
left-of 		 &0.0041	 &0.0094	       &0.0131 * target-tiene +0.0253 * adj-target-tiene +-0.0507\\
...
small		 &0.1499	 &0.1755	 &0.3918 * target-tiene + 0.2478 * vecino-tiene + -0.0913\\
front     & & & \\
\end{table}
...
%peque\~no esfera arriba de cubo peque\~no & 1 & 0.71\% \\
