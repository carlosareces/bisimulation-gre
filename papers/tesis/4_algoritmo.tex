...
\newsavebox{\mybox} 
\savebox{\mybox}{\includegraphics[scale=0.40]{images/modelo15.png}} 
 \begin{figure}
   \begin{picture}(8,6)
  \put(0,0){\usebox{\mybox}} 
  %\put(2,2.5){\oval(6,5)}
...
\newsavebox{\mybox} 
\savebox{\mybox}{\includegraphics[scale=0.40]{images/modelo16.png}} 
 \begin{figure}
   \begin{picture}(8,6)
  \put(0,0){\usebox{\mybox}} 
  %\put(2,2.5){\oval(6,5)}
...
\newsavebox{\mybox} 
\savebox{\mybox}{\includegraphics[scale=0.40]{images/modelo17.png}} 
 \begin{figure}
   \begin{picture}(8,6)
  \put(0,0){\usebox{\mybox}} 
  %\put(2,2.5){\oval(6,5)}
