...
De acuerdo a las propiedades o relaciones que una expresi\'on referencial (ER) incluya, se clasifican en distintos tipos: relacional o no relacional (tambi\'en llamada proposicional), m\'inimal, sobreespecificada, o subespecificada, plural y parcial. A continuaci\'on describimos cada uno de estos tipos.
