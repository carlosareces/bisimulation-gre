...
Para reducir el orden de la b\'usqueda Dale \& Reiter hicieron el algoritmo Incremental que reduce la complejidad del algoritmo Greedy cambiando en el paso 2 en vez de chequear cual propiedad es la que elimina m\'as distractores, eligiendo la que sigue en la lista de propiedades ordenada y que elimina al menos un distractor. Este algoritmo es de orden polinomial.
