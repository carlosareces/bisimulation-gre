...
En \cite{keysar:Curr98} se estudia como la gente usa el lenguaje para trasmitir y entender sus intenciones. Llegan a la conclusi\'on que los adultos al igual que los ni\~os procesan el lenguaje egoc\'entricamente, ajustando las expresiones s\'olo cuando detectan que no se entendieron. 
...
%Los números no son directamente comparables, ya q el filtro solo las relacionales y uso el total del corpus y nosotros usamos la mitad del corpus (solo verde, azul)
