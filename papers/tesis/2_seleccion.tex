...
En este cap\'itulo emplicaremos los tipos de expresiones referenciales, daremos una introducci\'on a la generaci\'on autom\'atica de expresiones referenciales y a los tipos de algoritmos para generarlas, y luego explicaremos los algoritmos m\'as conocidos del \'area. 
...
\section{Tipos de algoritmo de GER}
...
El input de un algoritmo de GER es en general el contexto, y el target. El contexto puede venir dado en distintos lenguajes, por ejemplo: el contexto que toma como input el algoritmo GRAFH es un grafo etiquetado, el cual contiene la informac\'on de las propiedades y relaciones de los objetos, y el contexto para el algoritmo de bisimulaci\'on es un XML con la misma informaci\'on.
