...
En el comienzo ER=$\{\top\}$ y $\interp{\top}$ = $\{e_1, e_2, e_3, e_4, e_5, e_6, e_7\}$\\

\begin{figure}[ht]
\begin{center}
\frame{\includegraphics[width=13cm]{images/modelo.png}}\\[0pt]
\caption{Modelo de la Figura \ref{figure22}}
\label{fig-modelo}
\end{center}
\end{figure}
El primer bucle del algoritmo es en las propiedades. Para cada propiedad hace add$_\el$ ($\varphi$, RE),

\begin{figure}[ht]
\begin{center}
\frame{\includegraphics[width=13cm]{images/modelo2.png}}\\[0pt]
...
\begin{figure}[ht]
\begin{center}
\frame{\includegraphics[width=13cm]{images/modelo3.png}}\\[0pt]
\caption{El cuadro indica cuales son ``ball''}
\label{fig-modelo3}
\end{center}
\end{figure}

La siguiente propiedad es \textsf{cube}, ER = \{$\top$, \textsf{ball}, \textsf{cube}\}, pero ahora la $\interp{\textsf{ball}}$ = $\{e_1, e_3, e_5\}$, $\interp{\textsf{cube}}$ = $\{e_2, e_4, e_6, e_7\}$,
\begin{figure}[ht]
\begin{center}
\frame{\includegraphics[width=13cm]{images/modelo4.png}}\\[0pt]
...
\begin{figure}[ht]
\begin{center}
\frame{\includegraphics[width=13cm]{images/modelo9.png}}\\[0pt]
...
\begin{figure}[ht]
\begin{center}
\frame{\includegraphics[width=13cm]{images/modelo10.png}}\\[0pt]
...
\begin{figure}[ht]
\begin{center}
\frame{\includegraphics[width=13cm]{images/modelo11.png}}\\[0pt]
...
\begin{figure}[ht]
\begin{center}
\frame{\includegraphics[width=13cm]{images/modelo15.png}}\\[0pt]
...
\begin{figure}[ht]
\begin{center}
\frame{\includegraphics[width=13cm]{images/modelo16.png}}\\[0pt]
\caption{Cuadros indicando ``ball'', ``cube'', ``red'', ``yellow''...}
\label{fig-modelo16}
\end{center}
\end{figure}
...
\begin{figure}[ht]
\begin{center}
\frame{\includegraphics[width=13cm]{images/modelo17.png}}\\[0pt]
\caption{Cuadros indicando ``ball'', ``cube'', ``red'', ``yellow''...}
\label{fig-modelo17}
\end{center}
\end{figure}
