...
\textcolor{blue}{de la tesis de Jette -El dominio define los tipos de entidades que est\'an siendo contemplados, de alguna
casos incluso un determinado conjunto de entidades con todas sus propiedades.El
conjunto contexto
contiene un subconjunto de las entidades de dominio, por ejemplo, los puntos de referencia visibles en un cierto punto de la ruta para la que estamos dando direcciones, una
subconjunto de las fotograf\'ias utilizadas en una configuraci\'on experimental, o los ingredientes de cocina que ya se han mencionado en una receta. En un entorno visual, establece el contexto, incluyendo el
propiedades de sus objetos miembro y su configuraci\'on espacial, a menudo se llama una Planificaci\'on scene.Document, microplanificaci\'on y el sistema de Realizaci\'on Un cargada
con la generaci\'on de una descripci\'on en lenguaje natural por integraci\'on global filo ser\'a como m\'inimo
tienen que realizar las tareas de determinaci\'on del contenido (la selecci\'on de las propiedades de la
apuntar referente ser mencionado), lexicalizaci\'on (la elecci\'on de las palabras para representar
las propiedades), y la realizaci\'on ling\''u\'istica (la construcci\'on de una gramaticalmente correcto
sintagma nominal). Incluso la tarea de agregaci\'on puede argumentar para formar parte de la
generaci\'on de una descripci\'on distintiva, como el contenido sem\'antico de alguna fuerza
