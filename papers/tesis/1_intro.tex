...
\begin{subfigure}{.5\textwidth}
  \centering
\includegraphics[width=\textwidth]{images/22sinletrasRojo.jpg}
...
\end{subfigure}
\begin{centering}
\caption{Expresiones referenciales que identifican al objeto se\~nalado por la flecha. El texto ``rojo'' no aparec\'ia en la imagen, los objetos que no son rojos son amarillos.}
\label{figura-er}
\end{centering}
\end{figure}
...
El largo de una ER afecta su calidad. Se podr\'{i}a pensar, por ejemplo, que las referencias son \'optimas \ando son \textbf{m\'{i}nimas}
...
\cite{arec2:2008:Areces} el cual introducimos en el \ref{sec:intro_logica}, modificamos el algoritmo permitiendo sobreespecificaci\'on, 
