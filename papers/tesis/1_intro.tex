...
\begin{tabular}{l}
 ...
 $\phi_5$: La esfera grande y roja, y los dem\'as elementos o no son esferas o no est\'an a mi lado\\[1pt]
  %ex 2
 $\phi_6$: La esfera grande y roja que est\'a a la derecha de un cubo\\[1pt]
 % (x \not\approx y \land \nCube(y) \land \nRightof(x,y))
  %ex 3
...
En esta secci\'on daremos un breve res\'umen de cada cap\'itulo.
...
\subsection{Cap\'itulo~\ref{sec:corpus}: ``Recolecci\'on y an\'alisis del corpu ZOOM''} Introducimos un nuevo corpus, 
