...
%\begin{array}{cl}
 $\phi_1$: La esfera roja \\[3pt]

  %
 $\phi_2$: La esfera grande\\[3pt]

  %
 $\phi_3$: La esfera grande y roja\\[3pt]

  %
 $\phi_4$: La esfera grande y roja que est\'a a la derecha de un cubo grande y rojo\\[3pt]

  %ex1
 $\phi_5$: La esfera grande y roja, y los dem\'as elementos o no son esferas o no est\'an a mi lado\\[3pt]

  %ex 2
 $\phi_6$: La esfera grande y roja, y est\'a a la derecha de un cubo\\[3pt]
 % (x \not\approx y \land \nCube(y) \land \nRightof(x,y))
  %ex 3
 $\phi_7$: La esfera grande y roja que tiene un cubo rojo a la izquierda
  %ex 4
% \end{array}
%%$$
