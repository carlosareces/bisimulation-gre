...
\end{tabular}
\end{scriptsize}
\centering \caption{}\label{tabla-propiedades}
\end{center}
\end{subfigure}
...
no es lo que las personas hacen ni lo que es m\'as \'util para los oyentes, como se muestra en trabajo previo \cite{sasha-lu}. Y ni si quiera 
