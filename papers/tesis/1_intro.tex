...
hay muchas formas en las que $e_3$ puede ser identificado del resto (``la bola verde de la izquierda'',``la peque\~na bola verde'',``el bal\'on sobre el cubo azul''), la computadora tiene que decidir cu\'al de esas expresiones referenciales es \'optima en el contexto dado. Por otra parte, el concepto de \'optimo puede significar diferentes cosas.
