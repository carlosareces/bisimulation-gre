...
%\end{subfigure}%
\caption{Formalizaci\'on de las propiedades}
...
\begin{array}{cl}
 ...
 \end{array}
$$
\caption{Descripciones alternativas para el objeto $e_5$ de la Figura~\protect\ref{figura-er}, con lenguaje de $\FOL$.}\label{tab:phis}
\end{figure}
