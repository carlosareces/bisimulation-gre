...
\caption{Para esta escena el target \emph{blue chair facing left}.}
\label{Tuna-scene}
...
%\vspace*{-.4cm}
\caption{Para esta escena, la ER del target es \emph{the man with glasses}.} 
\label{Tuna-people-scene}
\end{subfigure}
\caption{Escenas del corpus TUNA.} 
\end{figure}
...
\section{Notas finales y linkeo del cap\'itulo}{sec:notas5}
