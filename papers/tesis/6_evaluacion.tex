...
\begin{tikzpicture}
  [
	...
	\node[n,label=below:$str16\nStreet$,label=above:{
    \relsize{-2}}, right of=b] (m) {};		 
...
\node[n,label=below:$str10\nStreet$,label=above:{
 ...
 \node[n,label=left:$min1\nBuilding$,label=above:{
    \relsize{-2}$\begin{array}{c}
      ...
      \nDe\\[-3pt] 
			\nAsuntos\\[-3pt] 
      \nExteriores\end{array}$}, above of=a] (f) {};	
					
  \node[n,label=above:$church1\nChurch$,label=above:{
    \relsize{-2}}, above of=f] (g) {};
			
 \node[n,label=above:$church2\nChurch$,label=below:{
    \relsize{-2}}, right of=c] (d) {};
			
  \node[n,label=below:$rest3\nRestaurante$,label=above:{
    \relsize{-2}$\begin{array}{c}
      \nMedina\\[-3pt] 
      \nMayrit\end{array}$}, above of=d] (h) {};			
			
 \node[n,label=below:$str9\nStreet$,label=above:{
    \relsize{-2}$\begin{array}{c}
      \nCalle\\[-3pt] 
      \nDe\\[-3pt] 
      \nAtocha\end{array}$}, above of=c] (e) {};		

\node[n,label=below:$rest4\nRestaurante$,label=above:{
    \relsize{-2}}, right of=m] (k) {};

\node[n,label=above:$d$,label=below:{
    \relsize{-2}}, right of=d] (i) {};
		
 \node[n,label=above:$str15\nStreet$,label=below:{
    \relsize{-2}}, above of=i] (j) {};	
    ...
    \relsize{-2}$\begin{array}{c}
      \nCalle\\[-3pt] 
   		\nDe\\[-3pt] 
			\nLa\\[-3pt] 
			\nConcepcion\\[-3pt] 
      \nJeronima\end{array}$}, below of=c] (q) {};
	\node[n,label=below:$str16\nStreet$,label=above:{
    \relsize{-2}}, right of=q] (m) {};		 
...
\node[n,label=below:$str10\nStreet$,label=above:{
    \relsize{-2}$\begin{array}{c}
      ...
      \nDe\\[-3pt] 
			\nSanto\\[-3pt] 
      \nTomas\end{array}$}, above of=q] (c) {};	
				
 \node[n,label=left:$min1\nBuilding$,label=above:{
    \relsize{-2}}, above of=a] (f) {};	
					
  \node[n,label=left:$church1\nChurch$,label=above:{
    \relsize{-2}$\begin{array}{c}
      \nParroquia\\[-3pt] 
      \nDe\\[-3pt] 
			\nSanta\\[-3pt] 
      \nCruz\end{array}$}, above of=f] (g) {};
...
\node[n,label=below:$rest4\nRestaurante$,label=above:{
 ...
 \node[n,label=below:$rest6\nRestaurante$,label=above:{
    \relsize{-2}$\begin{array}{c}
      \nLa\\[-3pt] 
      \nTagliatella\end{array}$}, below of=k] (p) {};		

 \node[n,label=above:$thea0\nTheater$,label=below:{
    \relsize{-2}$\begin{array}{c}
      \nTeatro\\[-3pt] 
      \nCalderon\end{array}$}, right of=d] (i) {};
		
 \node[n,label=above:$str15\nStreet$,label=below:{
    \relsize{-2}}, above of=i] (j) {};	
\node[n,label=above:$str21\nStreet$,label=below:{
    \relsize{-2}}, above of=i] (r) {};	
 \node[n,label=below:$str20\nStreet$,label=above:{
    \relsize{-2}$\begin{array}{c}
      \nCalle\\[-3pt] 
   		\nDe\\[-3pt] 
