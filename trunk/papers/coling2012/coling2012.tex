...
\author{$Romina Altamirano^{1}~~~Carlos Areces^{1}~~~Luciana Benotti^{1}$\\
{\small  	(1) FaMAF\_1, Medina Allende s/n, Ciudad Universitaria, Córdoba, Argentina\\ 
  \texttt{ialtamir@famaf.unc.edu.ar, carlos.areces@gmail.com, luciana.benotti@gmail.com} \\ 
}}
