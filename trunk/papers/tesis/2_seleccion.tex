...
generation (e.g., \cite{kelleher06:\_increm\_gener\_of\_spatial\_refer}),
...
classical algorithm
by~\shortcite{dale91:\_gener\_refer\_expres\_invol\_relat} was shown to be
unable to generate satisfying REs in practice (see the analysis over
the \emph{cabinet corpus}
in~\cite{viethen06:\_algor\_for\_gener\_refer\_expres}).  Furthermore, the
Dale and Haddock algorithm and many of its successors (such
as~\cite{kelleher06:\_increm\_gener\_of\_spatial\_refer}) are vulnerable to
